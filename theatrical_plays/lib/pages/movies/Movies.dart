...
class _MoviesState extends State<Movies> {
  ...
  late List<Movie> moviesToSearch; // Declared as late since it’s initialized in initState
  String query = '';
  List<Movie> selectedMovies = [];
                    ...
                    leading: Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                          movies[index].mediaUrl ?? 'https://default-url.jpg', // Handle nullable mediaUrl
                        ),
                      ),
                    ),
                    title: Text(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          selectedMovies.length < 5
                            ...
                            context,
                            MaterialPageRoute(
                                builder: (context) => CompareMovies(selectedMovies)),
                          )
                              : ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text("You can't compare more than 4 movies"),
                            ),
                          );
                        },
                      ),
