...
class HomeScreen extends StatefulWidget {
  ...
  @override
  _HomeScreenState createState() => _HomeScreenState(
      homeMovies: homeMovies, homeActors: homeActors, homeTheaters: homeTheaters);
}
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Actor> homescreenActors = [
    Actor('https://image.tmdb.org/t/p/w300/nv5TR9NiELEGPJUQqVLEqZzcGZb.jpg', 6911, 'Γιώργος Καραμίχος'),
    Actor('https://image.tmdb.org/t/p/w300/mR3QlGx3y68uVZriNzoOLOnwPy.jpg', 5044, 'Γιώργος Νινιός'),
    Actor('https://image.tmdb.org/t/p/w300/oiectxNJB7ctBwRKY45ChonEbjw.jpg', 7544, 'Γιώργος Παπαγεωργίου'),
  ];
  ...
  List<Movie> homescreenMovies = [
    Movie(
      ...
      mediaUrl: 'https://www.viva.gr/tickets/getattachment/d8b548e8-490c-488f-9939-afd8ed7e821c/%ce%a4%ce%9f-%ce%94%ce%99%ce%9a%ce%9f-%ce%9c%ce%91%ce%A3-%ce%a3%ce%99%ce%9d%ce%95%ce%9c%ce%91---Online-Streaminfc370b491-a9e4.png',
    ...
    Movie(
      ...
      mediaUrl: 'https://www.viva.gr/tickets/getattachment/232be7ca-c7d2-4c0f-be82-88fab33836b6/%ce%a4%ce%b5%ce%bb%ce%bf%cf%82-%cf%84%ce%bf%cf%85-%ce%a0%ce%b1%ce%b9%cf%87%ce%bd%ce%b9%ce%b4%ce%b9%ce%bf%cf%8505040124-543c-4bde-a969-920f2d.png',
      duration: null, // Nullable field
    ...
    Movie(
      ...
      mediaUrl: 'https://www.viva.gr/tickets/getattachment/36631a29-305c-438a-b596-4a2208d250aa/%ce%9f-%ce%91%cf%80%cf%81%ce%bf%cf%83%ce%ba%ce%bb%ce%b7%cf%84%ce%bf%cf%82-%ce%95%cf%80%cf%83%ce%ba%ce%b5%cf%80%cf%84%ce%b7%cf%82ebab1a2c-bbdc-439a-937a-6c.png',
      duration: null, // Nullable field
  ...
  List<Theater> homescreenTheaters = [
    Theater(id:302, title:'Νέος Ακάδημος', address:'Athens, Αττική', isSelected:false, ),
    Theater(id:305, title:'Σύγχρονο Θέατρο', address:'Κεραμεικός, Αττική', isSelected: false),
    Theater(id:303,title: 'Θέατρο Μικρο Χορν', address:'Κολωνάκι, Αττική', isSelected: false),
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: FloatingActionButton.extended(
                heroTag: "btn1",
                label: Text('See more actors', style: TextStyle(color: MyColors().cyan)),
                backgroundColor: MyColors().gray,
                onPressed: () {
                  Home.of(context)?.setBottomNav('Actors');
                },
            ...
            SizedBox(
              ...
              child: FloatingActionButton.extended(
                heroTag: "btn2",
                label: Text('See more movies', style: TextStyle(color: MyColors().cyan)),
                backgroundColor: MyColors().gray,
                onPressed: () {
                  Home.of(context)?.setBottomNav('Movies');
                },
            ...
            SizedBox(
              ...
              child: FloatingActionButton.extended(
                heroTag: "btn3",
                label: Text('See more theaters', style: TextStyle(color: MyColors().cyan)),
                backgroundColor: MyColors().gray,
                onPressed: () {
                  Home.of(context)?.setBottomNav('Theaters');
                },
          ...
          children: <Widget>[
            Center(
              child: Padding(
                ...
                child: CircleAvatar(
                  radius: 30.0,
                  backgroundImage: NetworkImage(homescreenMovies[index].mediaUrl ?? ''),
                ),
              ),
            ),
            ListTile(
            ...
            ListTile(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TheaterInfo(theaterId:homescreenTheaters[index].id),
                  ),
                );
              },
              title: Center(
